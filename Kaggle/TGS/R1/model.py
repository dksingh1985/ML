...
def unet2(pretrained_weights = None,input_size = (96,96,1)):
    inputs = Input(input_size)
    
    #Down Layer 1, 101
    dl_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(inputs)
    dl_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_1)
    dl_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_1)
    dl_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_1)
    dl_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_1)
    ...
    #Down Layer 2, 50
    dl_conv_2 = Conv2D(128, 9, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_pool_1)
    dl_conv_2 = Conv2D(128, 9, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_2)
    dl_conv_2 = Conv2D(128, 9, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_2)
    dl_conv_2 = Conv2D(128, 9, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_2)
    ...
    #Down Layer 3, 25
    dl_conv_3 = Conv2D(256, 7, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_pool_2)
    dl_conv_3 = Conv2D(256, 7, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_3)
    dl_conv_3 = Conv2D(256, 7, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_3)
    ...
    #Down Layer 4, 12
    dl_conv_4 = Conv2D(512, 5, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_pool_3)
    dl_conv_4 = Conv2D(512, 5, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(dl_conv_4)
    ...
    ul_conv_4 = Conv2D(512, 5, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_concat_4)
    ul_conv_4 = Conv2D(512, 5, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_4)
    ...
    ul_conv_3 = Conv2D(256, 7, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_concat_3)
    ul_conv_3 = Conv2D(256, 7, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_3)
    ul_conv_3 = Conv2D(256, 7, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_3)
    ...
    ul_conv_2 = Conv2D(128, 9, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_concat_2)
    ul_conv_2 = Conv2D(128, 9, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_2)
    ul_conv_2 = Conv2D(128, 9, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_2)
    ul_conv_2 = Conv2D(128, 9, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_2)
    ...
    ul_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_concat_1)
    ul_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_1)
    ul_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_1)
    ul_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_1)
    ul_conv_1 = Conv2D(64, 11, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(ul_conv_1)
