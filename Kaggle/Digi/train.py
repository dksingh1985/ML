...
model_checkpoint = ModelCheckpoint("D:\\data\\Kaggle\\digit-recognizer\\modelR0.h5", monitor='loss',verbose=1, save_best_only=False,save_weights_only=True)

history = model.fit(x_data,y_data,batch_size=50,epochs=200,verbose=1,validation_split=0.1, callbacks=[model_checkpoint])
