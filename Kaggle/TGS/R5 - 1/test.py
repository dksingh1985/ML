...
#myGene = trainGenerator(50,'D:\\Data\\Kaggle\\TGS\\train','image','mask',data_gen_args,image_color_mode = 'rgb', save_to_dir = None)
...
testGene = testGenerator("D:\\Data\\Kaggle\\TGS\\train\\image-test")
#print("tets egnt:", testGene.shape)
results = model.predict(testGene,0,verbose=1)
